...
(def-doom-theme doom-gruv-dark
  ...
  ((bg '("#000000")) ; bg0
   ...
   (base3      '("#393939" "#383838" "brightblack")) ; bg1
   (base4      '("#5d5d5d" "#5c5c5c" "brightblack")) ; bg3
   (base5      '("#71706f" "#6f6f6f" "brightblack")) ; bg4
   (base6      '("#868380" "#909090" "brightblack")) ; gray
...
;;; doom-gruv-dark-theme.el ends here
